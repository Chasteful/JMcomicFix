...
<style lang="scss">
  ...
  .effect {
    ...
    &.warn-1 {
      ...
      box-shadow: 0 2px 10px color-mix(in srgb, #ff0000 60%, transparent),
    ...
    &.warn-2 {
      ...
      box-shadow: 0 2px 10px color-mix(in srgb, #ff5555 60%, transparent),
      inset 0 0 6px rgba(255, 255, 255, 0.05);
    ...
    &.warn-3 {
      ...
      box-shadow: 0 2px 10px color-mix(in srgb, #ff8c00 60%, transparent),
      inset 0 0 6px rgba(255, 255, 255, 0.05);
