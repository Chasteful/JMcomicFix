<script lang="ts">
    ...
    import type {BlockCountChangeEvent, ClientPlayerDataEvent, EventMap,} from "../../../integration/events"
...
{#if silentHotbarEnabled && selectingHotbar}
    {#if count === undefined && playerData?.mainHandStack && playerData.mainHandStack.identifier !== "minecraft:air"}
        <div class="silent-hand-container" style="transform: scale({settings.scale});"
