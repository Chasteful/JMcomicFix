<script lang="ts">
    ...
    import {calcArmorValue} from "./calcArmorValue"
    import {armorValue, targetId} from '../island/Island';
    import {REST_BASE} from "../../../../integration/host";
    import {elasticOut, quintOut} from "svelte/easing";
    import {onMount, onDestroy} from "svelte";
    import {calcArmorColor, detectTeamColor, type TeamColor} from "./calcArmorColor";
    import ArmorStatus from "./ArmorStatus.svelte";
    import AvatarView from "../../../../components/PlayerView/AvatarView.svelte";
    import {primaryColor, secondaryColor} from '../../../../components/ThemeManager';
    import {get} from "svelte/store";
    import SFZ from "./Mode/SFZ.svelte";
        ...
        {#if !target.isDead}
            ...
            >
                <div class="main-wrapper">
                    ...
                    <!-- Name -->
                    <div class="name" style={`--flag-color: ${teamColorHex}`}>
                        {removeColorCodes(target.username)}
                        {#if teamColor && teamColorHex}
                            <div class="flag"></div>
                        {/if}
                    </div>
