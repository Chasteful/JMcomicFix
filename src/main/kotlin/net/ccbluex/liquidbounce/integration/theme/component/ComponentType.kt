...
enum class ComponentType(
    ...
    PLAYERLIST("PlayerListHUD",
        componentTweaks = arrayOf(
            FeatureTweak.DISABLE_PLAYERLIST_HUD,
        )
    ),

    CHAT_HUD("ChatHUD", componentTweaks = arrayOf(
    ...
    TITLE_CONTROL("TitleControl", componentTweaks = arrayOf(
        FeatureTweak.DISABLE_TITLE
    )),
    HEALTH_BAR("HealthBar", componentTweaks = arrayOf(
    ...
    STATUS("StatusBar", componentTweaks = arrayOf(
        ...
        MESSAGE("Message", componentTweaks = arrayOf(
        FeatureTweak.DISABLE_HELD_ITEM_TOOL_TIP,
        FeatureTweak.DISABLE_OVERLAY_MESSAGE
